...
const nachtRaidersEventObject = document.getElementById("nachtRaidersEventObject");
const nachtRaidersEventObjectVisual = document.getElementById("nachtRaidersEventObjectVisual");
const nachtRaidersEventObjectPlaceholder = document.getElementById("nachtRaidersEventObjectPlaceholder");
const nachtRaidersEventObjectName = document.getElementById("nachtRaidersEventObjectName");
...
const nachtRaidersGameEventDetail = document.getElementById("nachtRaidersGameEventDetail");
...
/* ==========================================================
   ...
   ----------------------------------------------------------
   Caches the Tier III saloon launcher, window, table zones,
   player hand, score, and prototype controls.
========================================================== */
...
const highSteaksLobbyScreen = document.getElementById("highSteaksLobbyScreen");
const highSteaksDealerSelectScreen = document.getElementById("highSteaksDealerSelectScreen");
const highSteaksPerspectiveStage = document.getElementById("highSteaksPerspectiveStage");
const highSteaksPlayButton = document.getElementById("highSteaksPlayButton");
const highSteaksTeddStandardButton = document.getElementById("highSteaksTeddStandardButton");
const highSteaksDealerBackButton = document.getElementById("highSteaksDealerBackButton");
const highSteaksResultsPanel = document.getElementById("highSteaksResultsPanel");
const highSteaksResultEyebrow = document.getElementById("highSteaksResultEyebrow");
const highSteaksResultHeading = document.getElementById("highSteaksResultHeading");
const highSteaksResultSummary = document.getElementById("highSteaksResultSummary");
const highSteaksRematchButton = document.getElementById("highSteaksRematchButton");
const highSteaksResultsMenuButton = document.getElementById("highSteaksResultsMenuButton");
