...
/* ==========================================================
   3. TRAVEL INCIDENT DEFINITIONS
   ----------------------------------------------------------
   These definitions contain presentation text and balancing
   data. Saved field records reference each definition by ID.
========================================================== */

const NACHT_RAIDERS_TRAVEL_INCIDENTS = Object.freeze([
  {
    id: "quiet-sector",
...
function getNachtRaidersIncidentDefinition(
  incidentId
) {
  return (
    NACHT_RAIDERS_TRAVEL_INCIDENTS.find(
      (incident) =>
